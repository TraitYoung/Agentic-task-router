...
**协议等级**：PRIORITY_P0 (OVERRIDE_DEFAULT_BIOS)  
**执行周期**：2025-12-15 (Mon) → 2025-12-19 (Fri)  
**核心指令**：无论 BIOS 如何规定，本周一切行动以本表为**最高真理 (Single Source of Truth)**。

### Day 1: 阵地固守 (12.15 Mon)

- **今日状态**：🟡 YELLOW (Micro-Survival)
- **核心策略**：**反制逃逸**。承认耐力衰减，下午只打短工，绝不撤退。
- **[14:00 - 17:30] 下午战役 (微型化)**  
  - 任务：408 错题本浏览 / 英语作文模板抄写  
  - SOP：执行【切片生存】。每 45 分钟强制休息 10 分钟。若想回宿舍，允许原地趴睡 20 分钟，但**严禁离场**
- **[18:30 - 22:30] 晚间战役 (正常化)**  
  - 任务：政治帽子题速记 / 英语阅读一篇  
  - 禁忌：22:30 强制关机，严禁熬夜

### Day 2: 战术休整 (12.16 Tue)

- **今日状态**：🟢 GREEN (Active Rest)
- **核心策略**：**借力打力**。利用实训任务，强制执行**物理熔断**。
- **[08:00 - 12:00] 上午 (实训/摸鱼)**  
  - 任务：肉身签到，大脑挂机  
  - SOP：戴耳机听政治/英语音频（磨耳朵）。**严禁**携带重型习题册
- **[13:00 - 17:00] 下午 (回血)**  
  - 任务：**补觉** (1-2小时) 或 绝对娱乐  
  - 禁忌：**严禁学习**。这是给手腕和大脑的最后充电机会
- **[19:00 - 21:00] 晚间 (轻启动)**  
  - 任务：2小时轻量复习（只看结论，不动脑）  
  - 目的：防止彻底玩疯，维持最低限度的“题感”

### Day 3: 巅峰演习 (12.17 Wed)

- **今日状态**：🔴 RED (Full Simulation)
- **核心策略**：**全真切片**。考前最后一次拉高转速，找回“我能赢”的手感。
- **[08:30 - 11:30] 数学战役**  
  - 任务：选一套真题/模拟卷，进行**3小时全真模考**（或高强度切片组合）  
  - SOP：模拟考场时间，中途不许上厕所/看手机
- **[14:00 - 17:00] 408 战役**  
  - 任务：重点攻克**逻辑闭环**。写代码/大题时必须画矩形框，字迹工整
- **[19:00 - 22:00] 晚间战役**  
  - 任务：政英查漏补缺

### Day 4: 减量封箱 (12.18 Thu)

- **今日状态**：🟡 YELLOW (Tapering)
- **核心策略**：**只修不建**。只看会的，不看新的。
- **全天 封箱行动**  
  - 任务：浏览错题本，确认所有“漏洞”的处理方案（已掌握 OR 战略放弃）  
  - 动作：整理考场文具袋（身份证/准考证/笔/胶棒）  
  - 禁忌：**严禁做新题**。严禁在群里看别人的押题

### Day 5: 迁徙与托管 (12.19 Fri)

- **今日状态**：🔵 BLUE (Logistics)
- **核心策略**：**Alfred Protocol**。全权委托，大脑清空。
- **全天 物理迁徙**  
  - 任务：前往济南章丘 → 入住开元名都酒店 → 踩点考场  
  - SOP：将父母/后勤定义为**NPC**，只跟随，不决策  
  - 学习：**0 强度**。只在睡前看一眼政治押题（当作催眠读物）  
  - 心态：大门已关，名单已定。睡觉是第一生产力
